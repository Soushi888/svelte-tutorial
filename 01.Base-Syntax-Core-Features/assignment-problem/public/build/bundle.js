...
var app = (function () {
    ...
    /* src/CourseGoal.svelte generated by Svelte v3.42.2 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1xxp2fl");
    			toggle_class(h1, "exclamation", /*hasExclamation*/ ctx[1]);
    			add_location(h1, file$1, 6, 0, 94);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ courseGoal, hasExclamation });

    	$$self.$inject_state = $$props => {
    		if ('courseGoal' in $$props) $$invalidate(0, courseGoal = $$props.courseGoal);
    		if ('hasExclamation' in $$props) $$invalidate(1, hasExclamation = $$props.hasExclamation);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*courseGoal*/ 1) {
    			$$invalidate(1, hasExclamation = courseGoal.includes('!'));
    		}
    	};

    	return [courseGoal, hasExclamation];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 7, 0, 93);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "course-goal");
    			add_location(input, file, 7, 47, 140);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
