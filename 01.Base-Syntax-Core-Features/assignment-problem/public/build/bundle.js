    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 2, 0, 19);
    			add_location(p, file, 4, 0, 40);
    			add_location(li0, file, 7, 2, 74);
    			add_location(li1, file, 8, 2, 146);
    			add_location(li2, file, 9, 2, 192);
    			add_location(li3, file, 12, 2, 303);
    			add_location(ol, file, 6, 0, 67);
    		},
